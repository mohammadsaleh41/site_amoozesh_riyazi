{
  ...
  const draw = (once) => {
    ...
    // Draw protraction Line
    config.drawLineprotraction && $drawLine( x + h * r * cos , y + h *r * sin, x - h* r * cos, y - h* r * sin, { color: COLORS.gray });
    ...
    config.drawLineTan && $drawRect(lineX, lineY, rightAngleSquareSide, rightAngleSquareHeight, { color: COLORS.gray, angle: tanCotAngle, lineWidth: 1 });
    config.drawLineCot && $drawRect(lineX, lineY, -rightAngleSquareSide, rightAngleSquareHeight, { color: COLORS.gray, angle: tanCotAngle, lineWidth: 1 });
    ...
    if (degree % 90) {
      ...
      // Draw Tangent2
      config.drawLineTan2 && $drawLine(x+r , y, x+r , (y+ r * (sin/cos)), { color: COLORS.orange });
      // Draw Cotangent2.
      config.drawLineCot2 && $drawLine(x , y - r , (x - r * (cos/sin)) , y - r, { color: COLORS.pink });
      ...
      // Draw tangent2 text.
      config.drawNameTan2 && $drawText(x + r + 5 , y + (r * (sin/cos)) / 2, name.tan, { color: COLORS.orange, angle: 90 });
      // Draw cotangent2 text.
      config.drawNameCot2 && $drawText( x - (r * (cos/sin)) /2 , y - r - 5 , name.cot, { color: COLORS.pink, angle: 0 });
